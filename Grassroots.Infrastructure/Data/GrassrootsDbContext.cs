...
{
    public class GrassrootsDbContext : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 应用实体配置
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(GrassrootsDbContext).Assembly);
        }
